<div class="row" style="">      <!-- Form Name -->
      <legend> <a href="<?php echo base_url(); ?>index.php/OrganismOrder/">Taxonomies / Insects / Orders</a></legend>
                       ...
                       <div class="row">
                        ...
                        <div id="divAdd" class="col-md-3">
                            ...
                            <div class="input-group ">
                               <input id="nameOrder" type="text" class="form-control" placeholder="Name" required>
                                     <span class="input-group-btn">
                                      <button id="addOrder" onclick="addOrder()"  class="btn btn-success" type="button">Add</button>
                                     </span>
                        ...
                        <div id="alertSuccess" class="col-md-2 alert hide alert-success alert-dismissible" style="padding: 6px; margin-bottom: 0px;" role="alert">
                          <strong>Successful!</strong> Order successfully added.
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive" style="width:480px">
                                <table class="table table-striped table-bordered"  id="dataTableOrders">
                                    <thead>
                                        <tr class="odd gradeX">
                                            <th>Name</th>
                                    ...
                                    <tbody>
                                        <?php
                                           ...
                                           foreach ($datos as $result => $row) {
                                              ...
                                              echo '<td id=td_'.$row->idOrder.'>' .$row->orderName. '</td>';
                                              echo '<td id='.$row->idOrder.' ><a id=edit_'.$row->idOrder.' class="Edit fa fa-edit" href="javascript:editOrder('.$row->idOrder.');"> Edit</a>  |
                                                    <a class="Delete fa fa-trash-o" href="javascript:deleteOrder('.$row->idOrder.');" > Delete</a>
                                                    </tr>';
                                           }
                                           }
                                        ?>
