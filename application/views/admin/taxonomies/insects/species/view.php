<section class="content-header">
    <h1>Species<small>Insects | View</small></h1>
    <ol class="breadcrumb">
                                    ...
                                    <tbody>
                                        <?php
                                           ...
                                           foreach ($datos as $result => $row) {
                                              ...
                                              echo '<td id=tdg_'.$row->idSpecies.'>' .$row->genderName. '</td>';
                                              echo '<td id=tdc_'.$row->idSpecies.'>' .$row->familyName. '</td>';
                                              echo '<td id=tdcnt_'.$row->idSpecies.'>' .$row->orderName. '</td>';
                                              echo '<td id='.$row->idSpecies.' ><a id=edit_'.$row->idSpecies.' class="Edit fa fa-edit" href="javascript:editSpecies('.$row->idSpecies.','.$row->idGender.','.$row->idFamily.','.$row->idOrder.');"> Edit</a>  |
