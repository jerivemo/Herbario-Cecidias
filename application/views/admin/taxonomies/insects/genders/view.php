<section class="content-header">
    <h1>Genders<small>Insects | View</small></h1>
    <ol class="breadcrumb">
                                    ...
                                    <tbody>
                                        <?php
                                           ...
                                           foreach ($datos as $result => $row) {
                                              ...
                                              echo '<td id=tdcnt_'.$row->idGender.'>' .$row->orderName. '</td>';
                                              echo '<td id='.$row->idGender.' ><a id=edit_'.$row->idGender.' class="Edit fa fa-edit" href="javascript:editGender('.$row->idGender.','.$row->idFamily.','.$row->idOrder.');"> Edit</a>  |
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h3 class="modal-title" id="myModalLabel">Add a new Gender</h3>
                                        </div>
